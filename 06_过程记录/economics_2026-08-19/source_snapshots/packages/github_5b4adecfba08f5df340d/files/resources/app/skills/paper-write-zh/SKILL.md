...
3. **figures/** — PDFs + `latex_includes*.tex` + `tikz_architecture_examples.tex`
...
- 绝对禁止两张图连续出现中间没有分析段落
- 图片用 `\includegraphics[width=0.85\textwidth,height=0.38\textheight,keepaspectratio]`
...
echo "  总计: $total 字符"
# MAX_PAGES=30 → at least 24000-30000 chars
# MAX_PAGES=15 → at least 12000-15000 chars
```
