...
- Customer growth (X,XXX → Y,YYY customers)
- Product milestones
- Team growth (X → Y employees)
...
**Week of [Date]**
**☀️ Welcome to another week at [Company]!**
...
### Team Milestone
Our Engineering team closed **50 bugs** this sprint! 🐛
...
Know someone great? Refer them and earn $2,000! → [link]

### Upcoming Events
**[Event Name]** - [Date]
Join us for [description]. RSVP → [link]
...
🌟 **@sarah** for staying late to fix the production bug
🌟 **@james** for the amazing customer demo
🌟 **@maria** for helping onboard our new hires
...
- 🏔️ Outdoor activity (hiking, picnic)
- 🎮 Game night (virtual or in-person)
- 🍕 Casual dinner or happy hour
- 🎓 Learning workshop
...
**[CITY, STATE – DATE]** – [Company Name], [brief company description], today announced [key announcement]. [One sentence about why this matters or what problem it solves].
...
### DON'Ts
- ❌ Say "no comment" (use "we're still gathering information")
- ❌ Speculate or guess
...
- **Company A**: [Challenge] → [Solution] → [Results]
- **Company B**: [Challenge] → [Solution] → [Results]
