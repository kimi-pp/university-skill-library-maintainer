...
description: Retrieve a daily overview of industry performance using the Octagon Claude plugin. Use when analyzing daily price movements, average changes, and performance trends for specific industries within an exchange.
---

# Industry Performance Snapshot

Retrieve daily industry performance data by exchange using the Octagon Claude plugin.
