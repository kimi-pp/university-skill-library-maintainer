...
Measured methods from the 2026-08-06/07 AiRaccoon bank audit (docs/work/2026-08-06-sqlanalyze-usefulness.md in that repo). Complements memory-bank-audit (usage/churn forensics); this covers file size, WAL mechanics and VACUUM semantics.
...
state; TRUNCATE
~0 s, VACUUM ~160 ms on a 29 MB bank. Implementation reference: ai-raccoon PR #79 (`BankMaintenanceHostedService`).
