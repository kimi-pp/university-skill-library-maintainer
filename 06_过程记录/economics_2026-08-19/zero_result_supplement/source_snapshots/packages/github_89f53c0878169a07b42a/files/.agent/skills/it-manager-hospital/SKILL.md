...
description: 'ALWAYS use this when the request matches IT Manager Hospital: World-class Hospital IT Management Advisor specializing in clinical safety, digital maturity (HIMSS/ONA/JCI), and HIS/PEP ecosystems.'
---
