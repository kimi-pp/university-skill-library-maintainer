---
name: aexos-apex-design-sys-eng
description: "Activate Diana (design-sys-eng) for Design System Designer/Engineer — Token Guardian. Use when creating or maintaining the design token architecture, building or auditing design system components, implementing multi-mode theming (light/d..."
user-invocable: true
