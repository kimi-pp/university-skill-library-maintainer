...
1. **Name the two or three papers you are actually arguing with** — the closest prior estimates, by name, and what they got. Vague "a large literature" hedging reads as not knowing the field.
2. **State the gap as a deficiency in those papers** — sorting bias, hypothetical bias, partial-equilibrium myopia, an outdated policy regime, no welfare number.
3. **State your delta in one sentence** — "We provide the first [quantity] identified from [variation], correcting [bias] that biased prior estimates by [direction]."
4. **Cite the field's reviews and the AERE/EAERE community** so referees see you know the conversation, but do not pad.
