...
### 4. 
Obtain and keep on file the client’s complete US and UK tax identifiers, including their taxpayer number, filing verification number, and national tax reference, preserving them in their original format to streamline computations.
