...
# Matplotlib 通用绘图（matplotlib）

> 用面向对象接口完成可控的二维绘图、布局、标注和多格式导出。

## 功能说明

用面向对象接口完成可控的二维绘图、布局、标注和多格式导出。 本轮读取了 378 行说明，重点核对了Matplotlib、Overview、When to Use This Skill、Setup、Core Concepts。该结论仅反映说明与包结构，不代表依赖已安装或任务已成功运行。

## 适用对象与场景

- 适用角色：学生、教师、科研人员、数据与技术支持人员
- 典型场景：课程作业、科研数据处理、统计建模、机器学习和科学图表
- 功能标签：Matplotlib、静态图、子图、导出
...
- 验证层级：二级包内容验证
- 验证结果：读取 378 行 SKILL.md；检查 skill 范围内 7 个文件，其中脚本 2 个、references/assets/templates 资源 4 个。
- 运行状态：未安装、未运行；如需最小运行验证，须另行取得用户指令。

## 来源

- Skill 地址：[https://github.com/K-Dense-AI/scientific-agent-skills/blob/main/skills/matplotlib/SKILL.md](https://github.com/K-Dense-AI/scientific-agent-skills/blob/main/skills/matplotlib/SKILL.md)
