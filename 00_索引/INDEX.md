...
- [文件化自动维护工作流（仅手动执行，自动运行已禁用）](<../07_自动维护工作流/>)
...
- 版本与证据：正式条目及条件、适配、排除观察都参加逐入口版本复核；同仓已是最新的入口不重复审查，已审版本别名避免重复复审。发布代次持久保存来源请求证据、固定归档、逐入口快照和清单，长期 manifest 使用可移植的路径/哈希/大小/角色；联网前复核最新及所有仍被业务表引用的前代证据。
