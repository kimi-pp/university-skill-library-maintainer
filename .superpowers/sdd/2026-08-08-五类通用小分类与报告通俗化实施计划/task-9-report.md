...
- CommonMark 裸空格目标、行内或引用式项目坏链、未跟踪项目 Markdown；
...
| 知识库与链接 | 61 个叶页、5 个大类导航、1 个总索引逐行一致；273 份项目 Markdown 的 1,261 个链接已解析，670 个本地目标均存在；引用式和未跟踪项目 Markdown 同样纳入 |
...
`d52c29e565ea89ed9b20953cf7c7122d41ecb2deda8b189bac6d702a7dd5cefe`
